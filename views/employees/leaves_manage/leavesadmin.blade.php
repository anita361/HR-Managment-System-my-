                                            ...
                                            <td>
                                                @foreach ($profiles as $key => $profile)
                                                    <h2 class="table-avatar">
                                                        <a href="#" class="avatar">
                                                            <img src="{{ URL::to('/assets/images/' . $profile->avatar) }}"
                                                                alt="">
                                                        </a>
                                                        <a
                                                            href="#">{{ $items->employee_name }}<span>{{ $profile->position }}</span></a>
                                                    </h2>
                                                @endforeach
                                            </td>
                                            ...
                                            <td class="text-right">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item leaveDelete" href="#"
                    ...
                    <div class="modal-body">
                        <form class="applyLeave" action="{{ route('form/leaves/save') }}" method="POST">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select select2s-hidden-accessible" style="width: 100%;"
                                            tabindex="-1" aria-hidden="true" id="employee_name" name="employee_name">
                            ...
                            <div class="row">
                                        ...
                                        <select class="select" id="leave_type" name="leave_type">
                                            ...
                                            @foreach ($leaveInformation as $key => $leaves)
                                                @if (
                                                    ...
                                                    <option value="{{ $leaves->leave_type }}">{{ $leaves->leave_type }}
                                                    </option>
                                                @endif
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="remaining_leave"
                                            name="remaining_leave" readonly value="0">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="cal-icon">
                                            <input type="text" class="form-control datetimepicker" id="date_from"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="number_of_day" name="number_of_day"
                                    value="0" readonly>
                            </div>
                            <div class="row">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-btn delete-action">
                            <form action="{{ route('form/leaves/edit/delete') }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <button class="btn btn-danger btn-delete-leave" data-id="{{ $leave->id }}"
                                            data-toggle="modal" data-target="#delete_approve">Delete</button>
                                    </div>
                                    <div class="col-6">
                                        <a href="javascript:void(0);" data-dismiss="modal"
...
@section('script')
            ...
            if (!isNaN(dateFrom) && !isNaN(dateTo)) {
                ...
                if (numDays > 0) {
                    for (let d = 0; d < numDays; d++) {
                        ...
                        var formattedDate = currentDate.getDate() + ' ' + (currentDate.getMonth() + 1) + ',' + currentDate
                            .getFullYear();

                        document.getElementById('leave_day_select').style.display =
                            'block'; // or 'flex', depending on your layout
                        // Append each leave date to the display
                        if (numDays > 0) {
                            document.getElementById('leave_dates_display').style.display =
                                'block'; // or 'flex', depending on your layout
                            document.getElementById('select_leave_day').style.display =
                                'block'; // or 'flex', depending on your layout
                            ...
                            function generateLeaveDaySelects(numDays) {
                                ...
                                for (let d = 0; d < numDays; d++) {
                                    ...
                                    document.getElementById('leave_day_select').style.display =
                                        'none'; // or 'flex', depending on your layout
    ...
    <script>
        $(document).ready(function() {
            $('.btn-delete-leave').on('click', function() {
                var leaveId = $(this).data('id');
                $('#delete_approve').find('.e_id').val(leaveId);
            });
        });
    </script>
@endsection

                                    ...
                                    <li class="notification-message {{ $notification->is_read ? '' : 'unread' }}">
                                        <a href="{{ $notification->url ?? '#' }}">
                                            <div class="media">
                                                <span class="avatar">
                                                    <img alt="User Avatar"
                                                        src="{{ asset('assets/images/' . ($notification->user->avatar ?? 'default.png')) }}">
                                                </span>
                                        ...
                                        <a href="{{ route('chat', $message->sender->id) }}">
                                            <div class="list-item">
                                                <div class="list-left">
                                                    <span class="avatar">
                                                        <img alt=""
                                                            src="{{ asset('assets/images/' . ($message->sender->avatar ?? 'default.png')) }}">
                                                    </span>
                                                </div>
                                                <div class="list-body">
                                                    <span class="message-author">
                                                        <i class="fa fa-comment text-success mr-1"></i>
                                                        {{ $message->sender->name }}
                                                    </span>

                            ...
                            <tbody>
                                @foreach ($job_list as $key => $items)
                                    <tr>
                                        ...
                                        <td><a href="{{ url('job/details/' . $items->id) }}">{{ $items->job_title }}</a>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown action-label">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right jobtype_status">
                                                    <a hidden id="id_update{{ $items->id }}"
                                                        onclick="setTime({{ $items->id }})">{{ $items->id }}</a>
                                                    <a class="dropdown-item full_time{{ $items->id }}"
                                                        id="status{{ $items->id }}"
                                                        onclick="setTime({{ $items->id }})"><i
                                                            class="fa fa-dot-circle-o text-info"></i> Full Time</a>
                                                    <a class="dropdown-item part_time{{ $items->id }}"
                                                        id="status{{ $items->id }}"
                                                        onclick="setTime({{ $items->id }})"><i
                                                            class="fa fa-dot-circle-o text-success"></i> Part Time</a>
                                                    <a class="dropdown-item internship{{ $items->id }}"
                                                        id="status{{ $items->id }}"
                                                        onclick="setTime({{ $items->id }})"><i
                                                            class="fa fa-dot-circle-o text-danger"></i> Internship<a>
                                                            <a class="dropdown-item temporary{{ $items->id }}"
                                                                id="status{{ $items->id }}"
                                                                onclick="setTime({{ $items->id }})"><i
                                                                    class="fa fa-dot-circle-o text-warning"></i>
                                                                Temporary<a>
                                                                    <a class="dropdown-item remote{{ $items->id }}"
                                                                        id="status{{ $items->id }}"
                                                                        onclick="setTime({{ $items->id }})"><i
                                                                            class="fa fa-dot-circle-o text-dark"></i>
                                                                        Remote</a>
                                                                    <a class="dropdown-item others{{ $items->id }}"
                                                                        id="status{{ $items->id }}"
                                                                        onclick="setTime({{ $items->id }})"><i
                                                                            class="fa fa-dot-circle-o text-dark"></i>
                                                                        Others</a>
                                        ...
                                        @php
                                            $apply = DB::table('apply_for_jobs')
                                                ->where('job_title', $items->job_title)
                                                ->count();
                                        @endphp
                                        <td>
                                            <a href="{{ url('job/applicants/' . $items->job_title) }}"
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a href="#" class="dropdown-item edit_job" data-toggle="modal"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select @error('department') is-invalid @enderror"
                                            ...
                                            @foreach ($department as $value)
                                                <option value="{{ $value->department }}"
                                                    {{ old('department') == $value->department ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('no_of_vacancies') is-invalid @enderror"
                                            type="text" name="no_of_vacancies" value="{{ old('no_of_vacancies') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('experience') is-invalid @enderror"
                                            type="text" name="experience" value="{{ old('experience') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            class="form-control @error('salary_to') is-invalid @enderror" name="salary_to"
                                            value="{{ old('salary_to') }}">
                                    </div>
                                </div>
                            </div>
                        ...
                        <form action="{{ route('form/apply/job/update') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Job Location</label>
                                        <input class="form-control" type="text" id="e_job_location"
                                            name="job_location" value="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">

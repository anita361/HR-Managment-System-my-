            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_appraisal"><i
                                ...
                                @foreach ($appraisals as $key => $appraisal)
                                    <tr>
                                        ...
                                        <td hidden class="ability_to_meet_deadline">
                                            {{ $appraisal->ability_to_meet_deadline }}</td>
                                        <td hidden class="status">{{ $appraisal->status }}</td>

                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="profile.html" class="avatar"><img alt=""
                                                        src="{{ URL::to('/assets/images/' . $appraisal->avatar) }}"
                                                        alt="{{ $appraisal->avatar }}"></a>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item edit_appraisal" href="#"
                                                        data-toggle="modal" data-target="#edit_appraisal"
                                                        data-id="{{ $appraisal->id ?? '' }}"
                                                        data-name="{{ $appraisal->name ?? '' }}"
                                                        data-date="{{ $appraisal->date ?? '' }}"
                                                        data-customer_experience="{{ $appraisal->customer_experience ?? '' }}"
                                                        data-marketing="{{ $appraisal->marketing ?? '' }}"
                                                        data-management="{{ $appraisal->management ?? '' }}"
                                                        data-administration="{{ $appraisal->administration ?? '' }}"
                                                        data-presentation_skill="{{ $appraisal->presentation_skill ?? '' }}"
                                                        data-quality_of_work="{{ $appraisal->quality_of_work ?? '' }}"
                                                        data-efficiency="{{ $appraisal->efficiency ?? '' }}"
                                                        data-integrity="{{ $appraisal->integrity ?? '' }}"
                                                        data-professionalism="{{ $appraisal->professionalism ?? '' }}"
                                                        data-team_work="{{ $appraisal->team_work ?? '' }}"
                                                        data-critical_thinking="{{ $appraisal->critical_thinking ?? '' }}"
                                                        data-conflict_management="{{ $appraisal->conflict_management ?? '' }}"
                                                        data-attendance="{{ $appraisal->attendance ?? '' }}"
                                                        data-ability_to_meet_deadline="{{ $appraisal->ability_to_meet_deadline ?? '' }}"
                                                        data-status="{{ $appraisal->status ?? '' }}">
                                                        <i class="fa fa-pencil m-r-5"></i> Edit
                                                    </a>
                                                    <a class="dropdown-item delete_appraisal" href="#"
                                                        data-toggle="modal" data-target="#delete_appraisal"><i
                                        ...
                                        <select class="select" id="name" name="name">
                                            ...
                                            @foreach ($users as $user)
                                                <option value="{{ $user->name }}"
                                                    data-employee_id={{ $user->user_id }}>{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                                                        <ul class="nav nav-tabs nav-tabs-solid">
                                                            ...
                                                            <li class="nav-item"><a href="#appr_organizational"
                                                                    data-toggle="tab" class="nav-link">Organizational</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                                            ...
                                                                            <td>
                                                                                <select name="customer_experience"
                                                                                    ...
                                                                                    @foreach ($indicator as $indicators)
                                                                                        <option
                                                                                            value="{{ $indicators->per_name_list }}">
                                                                                            {{ $indicators->per_name_list }}
                                                                                        </option>
                                                                                    @endforeach
                                                                                </select>
                                                                            </td>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label>Select Date <span class="text-danger">*</span></label>
                                        <div class="cal-icon">
                                            <input class="form-control datetimepicker" type="text" id="e_date"
                                                name="date" value="">
                                        </div>
                                    </div>
                                </div>
                                                                ...
                                                                <table class="table">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">Intermediate</td>
                                                                            <td>
                                                                                <select id="e_customer_experience"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">Advanced</td>
                                                                            <td>
                                                                                <select id="e_marketing" name="marketing"
                                                                                    class="form-control">
                                                                                    @foreach ($indicator as $indicators)
                                                                                        <option
                                                                                            value="{{ $indicators->per_name_list }}">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">Expert / Leader</td>
                                                                            <td>
                                                                                <select id="e_presentation_skill"
                                                                ...
                                                                <table class="table">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">Beginner</td>
                                                                            <td>
                                                                                <select id="e_integrity" name="integrity"
                                                                                    class="form-control">
                                                                                    @foreach ($indicator as $indicators)
                                                                                        <option
                                                                                            value="{{ $indicators->per_name_list }}">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">Intermediate</td>
                                                                            <td>
                                                                                <select id="e_team_work" name="team_work"
                                                                                    class="form-control">
                                                                                    @foreach ($indicator as $indicators)
                                                                                        <option
                                                                                            value="{{ $indicators->per_name_list }}">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">Intermediate</td>
                                                                            <td>
                                                                                <select id="e_conflict_management"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">Advanced</td>
                                                                            <td>
                                                                                <select id="e_ability_to_meet_deadline"
...
@section('script')
    ...
    <script>
        $(document).on('click', '.edit_appraisal', function() {
            ...
            $('#e_date').val(_this.find('.date').text().trim());

            // helper to set select value (clear any previous temporary option first)
            function setSelectValue(selector, value) {
                var $sel = $(selector);
                if ($sel.length === 0) return; // element not present
                // if option exists, set it; else add a single option and set
                if ($sel.find('option[value="' + value + '"]').length) {
                    $sel.val(value);
                } else {
                    $sel.empty().append('<option selected value="' + value + '">' + value + '</option>');
                }
            }

            setSelectValue('#e_name', _this.find('.name').text().trim());
            setSelectValue('#e_designation', _this.find('.designation').text().trim());
            setSelectValue('#e_customer_experience', _this.find('.customer_experience').text().trim());
            setSelectValue('#e_marketing', _this.find('.marketing').text().trim());
            setSelectValue('#e_management', _this.find('.management').text().trim());
            setSelectValue('#e_administration', _this.find('.administration').text().trim());
            setSelectValue('#e_presentation_skill', _this.find('.presentation_skill').text().trim());
            setSelectValue('#e_quality_of_work', _this.find('.quality_of_work').text().trim());
            setSelectValue('#e_efficiency', _this.find('.efficiency').text().trim());
            setSelectValue('#e_integrity', _this.find('.integrity').text().trim());
            setSelectValue('#e_professionalism', _this.find('.professionalism').text().trim());
            setSelectValue('#e_team_work', _this.find('.team_work').text().trim());
            setSelectValue('#e_critical_thinking', _this.find('.critical_thinking').text().trim());
            setSelectValue('#e_conflict_management', _this.find('.conflict_management').text().trim());
            setSelectValue('#e_attendance', _this.find('.attendance').text().trim());
            setSelectValue('#e_ability_to_meet_deadline', _this.find('.ability_to_meet_deadline').text().trim());
            setSelectValue('#e_status', _this.find('.status').text().trim());
        });
    </script>

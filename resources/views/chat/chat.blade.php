                                ...
                                <div class="user-details mr-auto">
                                    <div class="float-left user-img">
                                        {{-- @foreach ($users as $user)
                                            <a class="avatar" href="{{ route('profile') }}" title="{{ $user->name }}">
                                                <img src="{{ URL::to('/assets/images/' . $user->avatar) }}" alt=""
                                                ...
                                                <div class="chat chat-left">
                                                    ...
                                                    <div class="chat-body">
                                                        <div class="chat-bubble">
                                                            <div class="chat-content">
                                                                <ul class="attach-list">
                                                                    <li class="pdf-file"><i class="fa fa-file-pdf-o"></i>
                                                    ...
                                                    <div class="chat-profile-info">
                                                        <ul class="user-det-list">
                                                            ...
                                                            <li>
                                                                <span>Email:</span>
                                                                <span
                                                                    class="float-right text-muted">johndoe@example.com</span>
                                                            </li>
                                                            <li>
                                                                <span>Phone:</span>
                                                    ...
                                                    <div class="transfer-files">
                                                        <ul class="nav nav-tabs nav-tabs-solid nav-justified mb-0">
                                                            <li class="nav-item"><a class="nav-link active"
                                                                    href="#all_files" data-toggle="tab">All Files</a></li>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="input-group mb-3">
                                <input id="chat-search" placeholder="Search to start a chat" class="form-control"
                                    type="text">
                            ...
                            <ul id="users-list" class="chat-user-list mb-3"></ul>

                            <!-- Recent Conversations -->
                            <div>
                                <h5>Recent Conversations</h5>
                                <ul class="chat-user-list" id="recent-list">
                                    @foreach ($recentConversations as $conv)
                                        ...
                                        @if ($otherUser)
                                            <li>
                                                <a href="#" class="start-chat" data-user-id="{{ $otherUser->id }}">
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body align-self-center text-nowrap">
                                                            ...
                                                            <span class="designation">{{ $otherUser->email }}</span>
                                                        </div>
                                                        <div class="text-nowrap align-self-center">
                                                            <div class="online-date">
                                                                {{ $conv->updated_at->diffForHumans() }}</div>
                                                        </div>
                                                    </div>
                                                </a>
                                            </li>
                            ...
                            <div>
                                ...
                                <ul class="chat-user-list" id="users-list-all">
                                    @forelse ($allUsers as $user)
                                        ...
                                        @endphp
                                        <li>
                                            <a href="#" class="start-chat" data-user-id="{{ $user->id }}">
                                                <div class="media">
                                                    <span class="avatar align-self-center">
                                                        <img src="{{ $avatar }}" alt="Avatar">
                                                    </span>

                                ...
                                <div class="user-details mr-auto">
                                    <div class="float-left user-img">
                                        <a class="avatar" href="{{ route('employee.profile', $selectedUser->user_id) }}"
                                            title="Mike Litorus">
                                            <img src="{{ URL::to('/assets/images/' . $selectedUser->avatar) }}" alt=""
                            ...
                            <div class="message-bar">
                                <div class="message-inner">
                                    ...
                                    <div class="message-area">
                                        <form id="chatForm">
                                            @csrf
                                            <input type="hidden" id="receiver_id" name="receiver_id" value="{{ $selectedUser}}">
                                                ...
                                                <div class="chat-profile-info">
                                                    <ul class="user-det-list">
                                                        ...
                                                        <li>
                                                            <span>DOB:</span>
                                                            <span
                                                                class="float-right text-muted">{{ $selectedUser->dob }}</span>
                                                        </li>
                                                        <li>
                                                            <span>Email:</span>
                                                            <span
                                                        ...
                                                        <li>
                                                            <span>Phone:</span>
                                                            <span
                                                                class="float-right text-muted">{{ $selectedUser->phone }}</span>
                                                        </li>
                                                    </ul>
                                                </div>
